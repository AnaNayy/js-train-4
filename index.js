...
// Завдання 2: Напишіть функцію, яка генерує рядок з символів на основі
// їх кодів Unicode

function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  // Використовуємо String.fromCharCode(), щоб створити рядок з символів code1,
  // code2, code3, code4, code5 на основі їх кодів Unicode
...
// Завдання 3: Напишіть функцію, яка генерує рядок з символів на основі їх
// кодів Unicode
...
function checkIfIncludes(mainStr, subStr) {
  // Використовуємо метод includes(), щоб перевірити, чи входить
  // підрядок subStr в рядок mainStr
...
function checkIfStartsWith(mainStr, subStr) {
  // Використовуємо метод startsWith(), щоб перевірити, чи починається
  // рядок mainStr з певного підрядка subStr
...
// Завдання 14: Напишіть функцію, яка буде перетворювати рядок в верхній або нижній
// регістр, в залежності від значення аргументу "caseType".
...
// Завдання 17: Напишіть функцію, яка видаляє частину рядка між двома індексами
